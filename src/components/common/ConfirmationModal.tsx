      ...
      >
        <div className="relative p-4 w-full max-w-md">
          <div className="relative p-4 text-center bg-white rounded-lg shadow transform transition-all">
            ...
            <svg
              className="text-gray-700 w-11 h-11 mb-3.5 mx-auto"
              aria-hidden="true"
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="mb-4 text-gray-900">{body}</p>
            <div className="flex justify-center items-center space-x-4">
              <button
                onClick={() => {
                  toggleModal();
                }}
                className="py-2 px-3 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-500 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10"
              >
                No, cancel
              </button>
              <button
                ...
                className="py-2 px-3 text-sm font-medium text-center text-white bg-red-800 rounded-lg hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300"
              >
                Yes, I'm sure
              </button>
            </div>
